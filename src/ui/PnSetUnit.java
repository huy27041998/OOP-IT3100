...
//        this.urlImg = urlImg;
    ...
    public void addControls() {
        ...
        lblName.setBounds(100, 15, 100, 20);
        this.add(lblName);
        sld = new JSlider(0, 2000);
        sld.setBounds(230, 15, 370, 20);
        sld.setBackground(new Color(251,232,193));
        this.add(sld);
        txt = new JTextField(3);
        txt.setBounds(620, 15, 45, 20);
        this.add(txt);
        btnSetMax = new JButton("Max");
        btnSetMax.setMargin(new Insets(0, 0, 0, 0));
        btnSetMax.setBounds(700, 15, 60, 20);
        this.add(btnSetMax);
    }
