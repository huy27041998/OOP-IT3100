...
public class SetUnitJDialog extends JDialog {
    ...
    public void addControls() {
        ...
        btnDispose.setBounds(780, 0, 20, 20);
        pnTitle.add(btnDispose);

        pnMain = new JPanel();
        pnMain.setLayout(null);
        pnMain.setPreferredSize(new Dimension(800, 1050));
        ...
        scDialog.setBounds(0, 50, 800, 480);
        con.add(scDialog);
        ...
        for (Army.Unit unit : Army.Unit.values()) {
            ...
            pnSetUnit[unit.ordinal()].setBounds(0, 30 + d, 800, 50);
            pnMain.add(pnSetUnit[unit.ordinal()]);
            d += 80;
        }

        btnOK = new JButton("OK");
        btnOK.setBounds(340, 1010, 110, 30);
