...
public class BattleFieldUI extends JDialog {
    ...
    PanelBattlefield pnBattlefield; //Editting
    ...
    public BattleFieldUI() {
        ...
        battleField = new BattleField(IsLandUI.currentHouse.getLevelOfHouse(), BattleField.TypeOfBattleField.EDITTING);
...
//});
        ...
        btnRun.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                IsLandUI.waveAttackPanel = new WaveAttackUI("WaveAttack", IsLandUI.myHouse.getSentRealArmy(), IsLandUI.myHouse.getSendingArmy(), IsLandUI.myHouse.getSendingBackArmy());
     ...
     public void setBattleField(Army.Unit unit) {
        ...
        switch (unit) {
            ...
            case Hoplite:
                ...
                battleField.resetUnitSlot(battleField, battleField.flank ,Army.Unit.Hoplite);
                battleField.reserve.getHop().clear();
                pnBattlefield.updates(pnBattlefield.pnFront, 0);
                for (int i = 0; i < pnSetUnitBattle[unit.ordinal()].getSld().getValue(); i++) {
                    battleField.reserve.getHop().push(new Hoplite());
                }
                x = battleField.setFrontLine();
                battleField.setFlankToSlot(false, x);
                pnBattlefield.updates(pnBattlefield.pnFront, 0);
            ...
            case SteamGiant:
                ...
                battleField.resetUnitSlot(battleField, battleField.flank ,Army.Unit.SteamGiant);
